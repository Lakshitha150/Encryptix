...
original_vs_predicted_path = "Movie_Genre_Classification/RESULT_CSV/SVM_original_vs_predicted-sample.csv"
result_path = "Movie_Genre_Classification/RESULT_CSV/SVM_Result.txt"
